...
export const INITIAL_EMPLOYEES: InitialEmployee[] = [
  ...
  { id: '7', name: 'Murphy, Joe', isOnLeave: true },
  { id: '8', name: 'Ndata, Sihle', isOnLeave: true },
  { id: '9', name: 'Rolomane, Nosipho', isOnLeave: false },
  { id: '10', name: 'Rude, Sivenathi', isOnLeave: false },
  { id: '11', name: 'Mabi, Lisa', isOnLeave: false },
  { id: '12', name: 'Winnaar, Shantyn', isOnLeave: false },
  { id: '13', name: 'Orie, Wayren', isOnLeave: false },
]
